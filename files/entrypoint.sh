...
# 设置各变量
WSPATH=${WSPATH:-'argo'}
UUID=${UUID:-'928965c0-16ef-4a0f-8a30-ea60815fa78a'}
WEB_USERNAME=${WEB_USERNAME:-'kdey'}
WEB_PASSWORD=${WEB_PASSWORD:-'haha2312'}
ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiZGNlYmU2M2E5YjZhNDU5ODRkZTNlNjcxYTI1ZGFiNmIiLCJ0IjoiOGVkZDk4ZWMtNGFhZC00M2U4LTk4ZGMtMzE4Y2Q5MjU4ZWY4IiwicyI6Ik1ERmtPV0ZpWTJJdFpqY3hNUzAwTVRGbUxXRTVZVGd0TnpNNFpqUm1PREF4TlRjdyJ9'}
ARGO_DOMAIN=${ARGO_DOMAIN:-'cho-ws.kdey.eu.org'}
WEB_DOMAIN=${WEB_DOMAIN:-'cho-wb.kdey.eu.org'}
